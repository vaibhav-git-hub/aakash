   ...
   private TimePickerDialog showTimePicker() {
    ...
    private void populateFields()  {
        ...
        if (mRowId != null) {
            ...
            rtime.setText(reminder.getString(
                    reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_RTIME)));
			...
			try {
	            ...
	            radiogroup.check(reminder.getInt(reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_TYPE)));
    ...
    private void saveState() {
    	...
    	String pass_type = "" + type;
    	float reqtime = Float.parseFloat(rtime.getText().toString());
        if (mRowId == null) {
        	
        	long id = mDbHelper.createReminder(title, body, reminderDateTime,pass_type,reqtime);
            if (id > 0) {
                mRowId = id;
            }
        } else {
            mDbHelper.updateReminder(mRowId, title, body, reminderDateTime,pass_type,reqtime);
        }
