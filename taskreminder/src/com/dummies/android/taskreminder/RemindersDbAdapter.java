...
public class RemindersDbAdapter {
     ...
     */
    public long createReminder(String title, String body, String reminderDateTime,String type, float rtime) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_TITLE, title);
        initialValues.put(KEY_BODY, body);
        initialValues.put(KEY_DATE_TIME, reminderDateTime);
        initialValues.put(KEY_TYPE, type);
        initialValues.put(KEY_RTIME, rtime);
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_DATE_TIME, KEY_TYPE, KEY_RTIME}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_TITLE, KEY_BODY, KEY_DATE_TIME, KEY_TYPE, KEY_RTIME}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateReminder(long rowId, String title, String body, String reminderDateTime,String type, float rtime) {
        ContentValues args = new ContentValues();
        args.put(KEY_TITLE, title);
        args.put(KEY_BODY, body);
        args.put(KEY_DATE_TIME, reminderDateTime);
        args.put(KEY_TYPE,type);
        args.put(KEY_RTIME,rtime);
